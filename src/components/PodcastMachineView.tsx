                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-1.5 ml-2">
                      ...
                      {["yellow", "cyan", "lime", "pink", "white", "orange"].map((c) => (
                        <button key={c} onClick={() => setSubHighlightColor(c)} className="w-6 h-6 rounded-full border-2 transition-all hover:scale-110 cursor-pointer" style={{ backgroundColor: c === "pink" ? "#FF2E88" : c === "lime" ? "#00E5FF" : c === "orange" ? "#F59E0B" : c, borderColor: subHighlightColor === c ? C.dark : "transparent", transform: subHighlightColor === c ? "scale(1.15)" : "scale(1)" }} />
                      ))}
                    </div>
                  </div>
