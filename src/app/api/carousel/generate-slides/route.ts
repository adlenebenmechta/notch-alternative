...
- صورة الحل MUST: يجب أن تظهر المنتج بوضوح في المشهد — شخص يستخدم المنتج أو المنتج ظاهر بشكل بارز في الإطار
- في image_prompt الخاص بالحل، اكتب وصف يوضح أين وكيف يظهر المنتج بالضبط في المشهد
