...
- ⛔ ممنوع تماماً وضع وجوه أو أشخاص في أي صورة — الوجوه تبدو مزيفة وغير واقعية. لا تكتب "person", "woman", "man", "people", "hands", "face" في أي image_prompt
- بدلاً من الأشخاص: ركّز على الأشياء، البيئة، المنتج نفسه، تفاصيل المكان، الإضاءة، الألوان
- صورة المشكلة: ألوان داكنة/before، بيئة فوضوية، أشياء مكسورة أو غير مرتبة — بدون أشخاص
- صورة الحل: ألوان زاهية/after، بيئة منظمة ونظيفة، المنتج ظاهر بوضوح — بدون أشخاص
- صورة الحل MUST: يجب أن تظهر المنتج بوضوح في المشهد — المنتج هو العنصر الرئيسي في الصورة
- في image_prompt الخاص بالحل: اكتب وصف يركز على المنتج أولاً ثم البيئة حوله، مثل: "A [product type] sitting on [surface] in [scene], product is the main focus and clearly visible, [lighting/mood]..."
- صيغة image_prompt للحل يجب أن تبدأ بوصف المنتج نفسه وليس المشهد
