  ...
  const renderFile = (file: FileItem) => (
    <div key={file.name} style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        {file.label && (
          <span style={{
            ...
            color: file.label.includes("Part") ? "#00E5FF" : "#FF2E88",
      ...
      <button
        ...
        style={{
          backgroundColor: downloading === file.name ? "#00E5FF" : "#FF2E88",
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 24 }}>
          <button
            ...
            style={{
              ...
              backgroundColor: activeTab === "full" ? "#00E5FF" : "#1A1A1A",
          ...
          <button
            ...
            style={{
              flex: 1, padding: "12px 16px", borderRadius: 12, border: "none",
              backgroundColor: activeTab === "single" ? "#FF2E88" : "#1A1A1A",
        ...
        {activeTab === "full" && (
          <>
            <div style={{
              ...
              <p style={{ color: "#00E5FF", fontSize: 13, fontWeight: 600, marginBottom: 8 }}>
            ...
            <div style={{
              ...
              <div style={{ backgroundColor: "#0A0A0A", borderRadius: 8, padding: 12, fontFamily: "monospace", fontSize: 11 }}>
                <p style={{ color: "#00E5FF", marginBottom: 4 }}># Windows (Command Prompt):</p>
                ...
                <p style={{ color: "#00E5FF", marginBottom: 4 }}># Mac / Linux:</p>
                ...
                <p style={{ color: "#00E5FF", marginBottom: 4 }}># Then extract normally — no need for npm install!</p>
              </div>
            </div>
          ...
          <>
            {loading ? (
              <div style={{ textAlign: "center", padding: 40 }}>
                <div style={{
                  width: 32, height: 32, border: "3px solid #333", borderTopColor: "#FF2E88",
            ...
            <div style={{
              ...
              <code style={{ color: "#FF2E88", fontSize: 11, display: "block", marginBottom: 4 }}>npm install</code>
              <code style={{ color: "#FF2E88", fontSize: 11, display: "block", marginBottom: 4 }}>npx prisma db push</code>
              <code style={{ color: "#FF2E88", fontSize: 11, display: "block" }}>npm run dev</code>
            </div>
          </>
        )}
