...
const DICT: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    "menu.title": "What would you like to create?",
    "menu.library": "My Library",
  ...
  fr: {
    ...
    "menu.title": "Que voulez-vous créer ?",
    "menu.library": "Ma bibliothèque",
